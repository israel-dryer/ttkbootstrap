...
accordion2 = Accordion(app, allow_multiple=True, accent="success", variant="solid")
...
accordion3 = Accordion(app, allow_collapse_all=False, accent="warning", variant="solid")
