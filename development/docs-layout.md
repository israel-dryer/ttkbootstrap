# ttkbootstrap v2 Docs — Final Navigation & Information Architecture

This document captures the **finalized navigation design** for the ttkbootstrap v2 documentation site, reflecting decisions aligned with MUI-style discoverability while remaining Tk-native.
...
- Answers: *“What kind of thing am I looking for?”*
...
All widgets are **directly reachable**. Categories are **landing pages** that link to widgets.
...
- Sidebar depth stays **≤ 3**
- Widgets are **first-class**
- Categories never nest widgets
- Dialogs never create subtrees

This structure is designed to scale with ttkbootstrap v2 while remaining approachable, discoverable, and professional.
