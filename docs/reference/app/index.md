...
additional toplevel windows, menus, shortcuts, and application-scoped settings.
...
- [Shortcuts](Shortcuts.md): cross-platform keyboard shortcut service
- [Shortcut](Shortcut.md): individual shortcut record
...
- [get_shortcuts](get_shortcuts.md): access the global shortcuts service
