...
class Style(ttk.Style):
    ...
    def load_izzy_themes(self):
        ...
        for theme in settings['themes']:
            ...
            ThemeEngine(self, theme['name'], colors, theme['font'], theme['type'])
...
class ThemeEngine:
    ...
    def __init__(self, style, name, colors, font, type):
        self.name = name
        self.style = style
        self.colors = colors
        self.font = font
    ...
    def register(self):
        """Register the theme in the style class"""
        self.style.__dict__[self.name] = self
    ...
    def style_treeview(self):
        ...
        self.style.configure('Treeview',
                             ...
                             lightcolor=self.colors.bg,
                             darkcolor=self.colors.bg,
                             relief='raised' if self.type == 'light' else 'flat',
                             padding=-1 if self.type == 'light' else -2)
