...
class Radio(BackgroundInheritMixin, StyledWidget, ttkRadiobutton):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._init_style('radiobutton', color=color, variant=self._variant, extras=self._extras, **kwargs)
