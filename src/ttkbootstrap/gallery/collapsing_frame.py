...
class CollapsingFrame(ttk.Frame):
    ...
    def add(self, child, title="", style='primary.TButton'):
        ...
        frm.grid(row=self.cumulative_rows, column=0, sticky='news')
        # header title
        lbl = ttk.Label(frm, text=title, style=f'{style_color}.TButton', font=('Helvetica 11 bold'))
        lbl.pack(side='left', fill='x', pady=10, padx=10)
        ...
        child.btn = btn
        child.grid(row=self.cumulative_rows + 1, column=0, sticky='ew', padx=5, pady=5)
