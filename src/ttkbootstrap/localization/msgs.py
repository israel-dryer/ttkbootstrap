...
MESSAGES.append(
    LocaleMsgs(
        ...
        ("Preview", "Anteprima"),
        ("Size", "Dimensione"),
        ("Should be of data type", "Deve essere di tipo"),
        ("Invalid data type", "Tipo di dato non valido"),
        ("Number cannot be greater than", "Il numero non può essere maggiore di"),
        ("Number cannot be less than", "Il numero non può essere minore di"),
        ("Select an item from the list", "Seleziona un elemento dalla lista"),
        ("Out of range", "Fuori intervallo"),
        ("Previous", "Precedente"),
        ("The quick brown fox jumps over the lazy dog.", "The quick brown fox jumps over the lazy dog."),
        ("Font Selector", "Selettore carattere"),
        ("normal", "normale"),
        ("bold", "grassetto"),
        ("roman", "tondo"),
        ("italic", "corsivo"),
        ...
        ("overstrike", "barrato"),
        ("Color Chooser", "Selettore colore"),
        ("Advanced", "Avanzate"),
        ("Themed", "Tema"),
        ("Standard", "Standard"),
        ("Current", "Corrente"),
        ...
        ("Move to first", "Sposta all'inizio"),
        ("Move to last", "Sposta alla fine"),
        ...
        ("Filter by cell's value", "Filtra per valore della cella"),
        ("Hide select rows", "Nascondi righe selezionate"),
        ("Show only select rows", "Mostra solo righe selezionate"),
        ("Export all records", "Esporta tutti i record"),
        ("Export current page", "Esporta pagina corrente"),
        ("Export current selection", "Esporta selezione corrente"),
        ("Export records in filter", "Esporta record filtrati"),
        ("Move up", "Sposta su"),
