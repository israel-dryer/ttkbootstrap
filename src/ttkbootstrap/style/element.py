"""TTK style element definitions for ttkbootstrap."""
...
class Element:
    ...
    def children(self, layout: Sequence["Element"]):
        """Add children to this layout element.
...
class ElementImage:
    ...
    def build(self):
        """Build the element arguments for element_create."""
    ...
    def state_specs(self, specs: list[Tuple[str, Union[str, PhotoImage]]]):
        """Add multiple state/image pairs from a list of specs."""
        for spec in specs:
            self.add_spec(*spec)
        return self
